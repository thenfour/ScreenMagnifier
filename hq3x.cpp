...
extern int*   LUT16to32;
extern int*   RGBtoYUV;

const __int64 reg_blank = 0;
const __int64 const7    = 0x0000000700070007;
...
//
//  if ( ImageOut.Init( ImageIn.m_Xres*3, ImageIn.m_Yres*3, 32 ) != 0 )
//  {
...
//  InitLUTs();
//
//  hq3x_32( ImageIn.m_pBitmap, ImageOut.m_pBitmap, ImageIn.m_Xres, ImageIn.m_Yres, ImageOut.m_Xres*4 );
//
