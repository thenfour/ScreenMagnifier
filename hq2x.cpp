...
void InitLUTs()
{
  ...
  LUT16to32 = (int*)HeapAlloc(GetProcessHeap(), 0, (sizeof(int)*65536));
  RGBtoYUV = (int*)HeapAlloc(GetProcessHeap(), 0, (sizeof(int)*65536));
...
void UninitLUTs()
{
  HeapFree(GetProcessHeap(), 0, LUT16to32);
  HeapFree(GetProcessHeap(), 0, RGBtoYUV);
}
